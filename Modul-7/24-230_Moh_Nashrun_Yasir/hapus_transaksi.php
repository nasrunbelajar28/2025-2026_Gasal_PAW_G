...
while ($t = mysqli_fetch_assoc($transaksi)) {
    echo "<tr>
            ...
            <td>
                <a href='lihat_detail.php?id=$t[id]' class='btn btn-teal'>Lihat Detail</a>
                <a href='hapus_transaksi.php?id=$t[id]' class='btn btn-red' onclick='return confirm(\"Yakin hapus transaksi ini?\")'>Hapus</a>
            </td>
          </tr>";
}
?>
