...
if (isset($_POST['simpan'])) {
    ...
    // Validasi tanggal telah dihapus agar bisa input data lama untuk laporan.
    
    if (strlen($keterangan) < 3) {
        echo "<script>alert('Keterangan minimal 3 karakter!');</script>";
    } else {
        // Query INSERT ke database db_penjualan7
...
<form method="post">
    ...
    <select name="pelanggan_id" required>
        ...
        <?php
        // Mengambil data pelanggan dari db_penjualan7
